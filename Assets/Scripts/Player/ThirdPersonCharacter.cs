...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		Animator m_Animator;
		const bool m_IsGrounded = true;
		const bool m_Crouching = false;
		...
		public void Move(Vector3 move, Vector3 aimDir)
		{
			...
			m_TurnAmount = Mathf.Atan2(aimDir.x, aimDir.z);
...
//             }
		...
		void ApplyExtraTurnRotation()
		{
			...
			float turnSpeed = Mathf.Lerp(m_StationaryTurnSpeed, m_MovingTurnSpeed, m_TurnAmount);
